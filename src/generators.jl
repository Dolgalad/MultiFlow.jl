...
# Example
```jldoctest randdemands; setup = :(using Random; Random.seed!(123); pb = load("../instances/sndlib/delay_corrected/AsnetAm_0_1_1", capacity_fieldname="bandwidth", demand_amount_fieldname="bandwidth"))
